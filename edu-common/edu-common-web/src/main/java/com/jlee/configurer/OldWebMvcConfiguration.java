 ...
 * @author jlee
 */
public class OldWebMvcConfiguration {
    ...
    public OldWebMvcConfiguration(ResponseResultProperties responseResultProperties, RequestMappingHandlerAdapter requestMappingHandlerAdapter, HandlerExceptionResolver handlerExceptionResolver) {
